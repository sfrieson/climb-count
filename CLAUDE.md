...
- `npm run test:e2e` - Run Puppeteer end-to-end tests (requires dev server)
...
- `tests/` - Jest test files (unit tests and E2E tests with Puppeteer)
- `tests/e2e/` - Puppeteer end-to-end test files
...
- **Development tooling**: Vite, ESLint, Prettier, Jest, Puppeteer (E2E tests), and Husky for pre-commit hooks
...
- This application has custom built dialogs and notifications.
